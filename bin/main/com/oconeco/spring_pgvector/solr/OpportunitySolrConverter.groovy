...
class OpportunitySolrConverter implements SolrDocumentConverter<Opportunity> {
    ...
    SolrInputDocument toSolrDocument(Opportunity opportunity) {
        ...
        doc.addField("title_t", opportunity.title)
        doc.addField("title_exact_s", opportunity.title)
        doc.addField("description_t", opportunity.description)
        ...
        doc.addField("naics_s", opportunity.naics)
        doc.addField("psc_s", opportunity.psc)
        ...
        doc.addField("set_aside_s", opportunity.setAside)
